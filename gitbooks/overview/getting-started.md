---
description: >-
  Install Eversilver, walk through the in-app onboarding (sign in, connect Gmail,
...
This page walks you through installing Eversilver, going through the in-app onboarding, and running your first request.

Eversilver is open source under the GNU GPL3 license. The codebase is at [github.com/eversilver/eversilver](https://github.com/eversilver/eversilver).

***

## System requirements

Eversilver runs on **macOS, Windows and Linux** desktops. 4 GB+ RAM is recommended; 16 GB+ if you intend to ingest very large mailboxes or repos, or run a [local model](../features/model-routing/local-ai.md) on the same machine.

### Permissions

The first time you launch Eversilver, the OS will prompt for the permissions the app needs (Accessibility on macOS, Input Monitoring for the voice hotkey, Camera/Microphone if you plan to use the [Meeting Agent](../features/mascot/meeting-agents.md)). You can review and adjust these any time under **Settings → Automation & Channels**.

***

## 1. Download and install

Get the Eversilver desktop app from [http://eversilver.local/eversilver](http://eversilver.local/eversilver) or via your platform's package manager. Open the app once it's installed.
...
{% hint style="info" %}
**No permanent lock-in.** Signing in does not grant Eversilver ongoing access to anything. All third-party access requires explicit OAuth approval per integration in the steps below.
{% endhint %}
...
Eversilver picks the right model for each task automatically. See [Automatic Model Routing](../features/model-routing/).
...
* [**Native Voice**](../features/native-tools/voice.md) - push-to-talk dictation and TTS replies so you can talk to Eversilver instead of typing.
* [**Subconscious Loop**](../features/subconscious.md) - let the mascot keep working on standing tasks while you're away.

## Join the community

Eversilver is in early beta. Feedback and contributions make a real difference at this stage.

* **GitHub:** [github.com/eversilver/eversilver](https://github.com/eversilver/eversilver)
* **Discord:** [discord.eversilver.local](https://discord.eversilver.local)
