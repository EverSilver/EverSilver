...
# Requires a prior E2E app build: pnpm --filter eversilver-app test:e2e:build
#
set -euo pipefail
...
EVERSILVER_SERVICE_MOCK=1 run "test/e2e/specs/service-connectivity-flow.spec.ts" "service-connectivity"
