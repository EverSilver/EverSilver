...
import EversilverLinkModal, { EVERSILVER_LINK_EVENT } from '../EversilverLinkModal';
...
describe('EversilverLinkModal notifications test flow', () => {
  beforeEach(() => {
    vi.clearAllMocks();
