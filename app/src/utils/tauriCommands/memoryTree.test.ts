...
describe('memoryTreeListChunks', () => {
  test('dispatches eversilver.memory_tree_list_chunks with the filter as params', async () => {
...
describe('memoryTreeGetLlm / memoryTreeSetLlm', () => {
  test('get_llm dispatches without params', async () => {
    ...
    expect(mockCallCoreRpc).toHaveBeenCalledWith({ method: 'eversilver.memory_tree_get_llm' });
...
describe('memoryTreeFlushNow', () => {
  test('dispatches flush_now and returns the unwrapped envelope', async () => {
    ...
    expect(mockCallCoreRpc).toHaveBeenCalledWith({ method: 'eversilver.memory_tree_flush_now' });
...
describe('memoryTreeWipeAll', () => {
  test('dispatches wipe_all and returns the unwrapped envelope', async () => {
    ...
    expect(mockCallCoreRpc).toHaveBeenCalledWith({ method: 'eversilver.memory_tree_wipe_all' });
...
describe('memoryTreeResetTree', () => {
  test('dispatches reset_tree and returns the unwrapped envelope', async () => {
    ...
    expect(mockCallCoreRpc).toHaveBeenCalledWith({ method: 'eversilver.memory_tree_reset_tree' });
