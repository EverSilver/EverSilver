...
interface ImportMetaEnv {
  readonly VITE_EVERSILVER_APP_ENV?: string;
  readonly VITE_EVERSILVER_CORE_RPC_URL?: string;
  readonly VITE_EVERSILVER_E2E_DEFAULT_CORE_MODE?: string;
  readonly VITE_EVERSILVER_E2E_RESTART_APP_AS_RELOAD?: string;
