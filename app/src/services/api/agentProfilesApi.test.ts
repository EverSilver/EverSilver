...
describe('agentProfilesApi', () => {
  ...
  it('lists and selects persistent agent profiles', async () => {
    ...
    expect(mockCallCoreRpc).toHaveBeenCalledWith({ method: 'eversilver.agent_profiles_list' });
    ...
    expect(mockCallCoreRpc).toHaveBeenLastCalledWith({
      method: 'eversilver.agent_profile_select',
  ...
  it('upserts and deletes profiles through core RPC', async () => {
    ...
    expect(mockCallCoreRpc).toHaveBeenCalledWith({
      method: 'eversilver.agent_profile_upsert',
      params: { profile },
    });
    ...
    expect(mockCallCoreRpc).toHaveBeenLastCalledWith({
      method: 'eversilver.agent_profile_delete',
