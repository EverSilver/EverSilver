...
use crate::eversilver::config::LocalAiConfig;
use crate::eversilver::local_ai::lm_studio_api::lm_studio_base_url_from_local_ai;
use crate::eversilver::local_ai::ollama_base_url;
use crate::eversilver::local_ai::provider::normalize_provider;
use crate::eversilver::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
...
mod tests {
    use super::*;
    use crate::eversilver::config::LocalAiConfig;
    use crate::eversilver::providers::traits::{ProviderCapabilities, ToolsPayload};
