...
use crate::eversilver::redirect_links::ops as rl_ops;
...
pub fn schemas(function: &str) -> ControllerSchema {
    match function {
        "shorten" => ControllerSchema {
            ...
            function: "shorten",
            description: "Persist a long URL and return its `eversilver://link/<id>` short form.",
        ...
        "expand" => ControllerSchema {
            ...
            inputs: vec![FieldSchema {
                name: "id",
                ty: TypeSchema::String,
                comment: "The short id (the hex portion after `eversilver://link/`).",
                required: true,
            }],
            outputs: vec![FieldSchema {
                name: "link",
        ...
        "rewrite_inbound" => ControllerSchema {
            ...
            description:
                "Rewrite every long URL in `text` to an `eversilver://link/<id>` placeholder \
        ...
        "rewrite_outbound" => ControllerSchema {
            ...
            description:
                "Expand every `eversilver://link/<id>` placeholder in `text` back to its full \
