...
use crate::eversilver::agent::triage::{
...
fn triage_action_to_score(action: crate::eversilver::agent::triage::TriageAction) -> f32 {
    use crate::eversilver::agent::triage::TriageAction;
    match action {
