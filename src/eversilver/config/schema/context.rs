...
//!
//! Knobs for the global `src/eversilver/context/` module — budget
...
use crate::eversilver::context::session_memory::SessionMemoryConfig;
...
pub struct ContextConfig {
    /// Master switch. When `false`, [`crate::eversilver::context::ContextManager`]
...
fn default_microcompact_keep_recent() -> usize {
    crate::eversilver::context::DEFAULT_KEEP_RECENT_TOOL_RESULTS
}

fn default_tool_result_budget_bytes() -> usize {
    crate::eversilver::context::DEFAULT_TOOL_RESULT_BUDGET_BYTES
}
