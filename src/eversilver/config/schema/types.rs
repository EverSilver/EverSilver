...
pub struct Config {
    ...
    /// migration under [`crate::eversilver::migrations`] runs successfully.
    ...
    /// [`crate::eversilver::scheduler_gate`].
    #[serde(default)]
    ...
    /// [`crate::eversilver::context::ContextManager`].
    #[serde(default)]
    ...
    //                            eversilver, behaves identically to "eversilver"
    //   "eversilver"            → Eversilver backend (api_url + api_key session JWT)
    ...
    #[serde(default)]
    pub cloud_providers: Vec<crate::eversilver::config::schema::cloud_providers::CloudProviderCreds>,
    ...
    /// [`crate::eversilver::config::schema::MeetConfig`]).
    #[serde(default)]
    pub meet: MeetConfig,
...
impl Default for Config {
    fn default() -> Self {
        let eversilver_dir =
            crate::eversilver::config::default_root_eversilver_dir().unwrap_or_else(|_| {
