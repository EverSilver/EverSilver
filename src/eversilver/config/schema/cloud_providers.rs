...
//! `"my-deepseek"`). The factory in `crate::eversilver::providers::factory`
...
impl AuthStyle {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::EversilverJwt => "eversilver_jwt",
            Self::None => "none",
        }
    }
}
...
/// [`crate::eversilver::providers::factory::auth_key_for_slug`].
///
/// ## Back-compat
///
...
pub fn is_slug_reserved(s: &str) -> bool {
    matches!(s.trim(), "" | "cloud" | "eversilver" | "ollama" | "pid")
}
...
pub fn migrate_legacy_fields(entry: &mut CloudProviderCreds) {
    ...
    if entry.auth_style == AuthStyle::Bearer {
        match lt {
            ...
            "eversilver" => {
                entry.auth_style = AuthStyle::EversilverJwt;
            }
            _ => {}
        }
    }
...
fn legacy_default_endpoint(type_str: &str) -> &'static str {
    match type_str {
        "eversilver" => "https://api.eversilver.ai/v1",
...
impl CloudProviderType {
    ...
    pub fn default_endpoint(&self) -> &'static str {
        match self {
            Self::Eversilver => "https://api.eversilver.ai/v1",
    ...
    pub fn auth_style(&self) -> AuthStyle {
        match self {
            Self::Eversilver => AuthStyle::EversilverJwt,
