...
use crate::eversilver::channels::email_channel::EmailConfig;
...
pub struct ChannelsConfig {
    ...
    /// handler in [`crate::eversilver::channels::proactive`] always
...
impl ChannelsConfig {
    /// Whether [`crate::eversilver::channels::start_channels`] has any integrations to listen on.
