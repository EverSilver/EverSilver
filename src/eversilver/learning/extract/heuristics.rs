...
//!
//! Three detectors feed [`crate::eversilver::learning::candidate::global()`]:
//!
...
//! intended to be called from [`crate::eversilver::learning::ReflectionHook`] or a
...
mod heuristics_tests {
    use super::*;
    use crate::eversilver::learning::candidate::{Buffer, FacetClass};
