...
use crate::eversilver::people::address_book::{self, AddressBookError, ContactsSource};
use crate::eversilver::people::store::PeopleStore;
use crate::eversilver::people::types::{Handle, Person, PersonId};
...
mod tests {
    use super::*;
    use crate::eversilver::people::address_book::tests::MockContactsSource;
    use crate::eversilver::people::types::AddressBookContact;
