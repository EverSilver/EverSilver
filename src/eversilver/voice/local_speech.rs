...
//! pipeline ([`crate::eversilver::local_ai::paths::resolve_piper_binary`]),
...
//! [`crate::eversilver::local_ai::install_piper`] which downloads the
//! Piper binary archive (`.zip` on Windows, `.tar.gz` on macOS / Linux)
//! into `~/.eversilver/bin/piper/`, extracts it, and stages the bundled
...
use crate::eversilver::local_ai::paths::{resolve_piper_binary_with_config, resolve_tts_voice_path};
