use super::*;
use crate::eversilver::tokenjuice::rules::load_builtin_rules;
...
fn match_output_pattern_returns_canned_message() {
    use crate::eversilver::tokenjuice::{
    ...
    let rule = crate::eversilver::tokenjuice::types::JsonRule {
    ...
    let compiled = compile_rule(
        rule,
        crate::eversilver::tokenjuice::types::RuleOrigin::Builtin,
...
fn on_empty_returns_custom_message() {
    use crate::eversilver::tokenjuice::{rules::compiler::compile_rule, types::RuleMatch};
    ...
    let rule = crate::eversilver::tokenjuice::types::JsonRule {
        ...
        counter_source: None,
        r#match: RuleMatch::default(),
        filters: Some(crate::eversilver::tokenjuice::types::RuleFilters {
...
fn pretty_print_json_transform_works() {
    ...
    let rule = crate::eversilver::tokenjuice::types::JsonRule {
        ...
        r#match: RuleMatch::default(),
        filters: None,
        transforms: Some(crate::eversilver::tokenjuice::types::RuleTransforms {
...
fn head_tail_zero_head() {
    use crate::eversilver::tokenjuice::text::head_tail;
