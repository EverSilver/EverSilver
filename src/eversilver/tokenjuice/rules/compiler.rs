...
use crate::eversilver::tokenjuice::types::{
...
mod tests {
    use super::*;
    use crate::eversilver::tokenjuice::types::{JsonRule, RuleMatch};
    ...
    fn invalid_regex_is_dropped_not_panicked() {
        use crate::eversilver::tokenjuice::types::{RuleCounter, RuleFilters};
    ...
    fn case_insensitive_flag() {
        use crate::eversilver::tokenjuice::types::RuleCounter;
    ...
    fn invalid_regex_in_keep_patterns_is_dropped() {
        use crate::eversilver::tokenjuice::types::RuleFilters;
    ...
    fn invalid_regex_in_match_output_is_dropped() {
        use crate::eversilver::tokenjuice::types::RuleOutputMatch;
