...
use crate::eversilver::memory::tree::tree_source::types::{Tree, TreeKind, TreeStatus};
...
mod tests {
    ...
    fn topic_tree_and_source_tree_share_scope_space_cleanly() {
        ...
        let (_tmp, cfg) = test_config();
        let source =
            crate::eversilver::memory::tree::tree_source::registry::get_or_create_source_tree(
                &cfg,
                "shared:slack:#eng",
            )
            .unwrap();
