...
//! - `eversilver.memory_tree_query_source`   — per-source summary retrieval
//! - `eversilver.memory_tree_query_global`   — cross-source digest for a window
//! - `eversilver.memory_tree_query_topic`    — entity-scoped retrieval
//! - `eversilver.memory_tree_search_entities` — fuzzy canonical-id lookup
//! - `eversilver.memory_tree_drill_down`     — walk summary children
//! - `eversilver.memory_tree_fetch_leaves`   — batch chunk hydration
//!
