...
use crate::eversilver::memory::tree::score::store::{lookup_entity, EntityHit};
use crate::eversilver::memory::tree::tree_source::store;
use crate::eversilver::memory::tree::tree_source::types::{Tree, TreeKind};
...
async fn rerank_by_semantic_similarity(
    ...
    use crate::eversilver::memory::tree::store::get_chunk_embedding;
...
async fn entity_hit_to_retrieval_hit(
    ...
    tokio::task::spawn_blocking(move || -> Result<Option<RetrievalHit>> {
        ...
        use crate::eversilver::memory::tree::retrieval::types::hit_from_chunk;
...
mod tests {
    ...
    async fn duplicate_node_is_deduplicated_across_index_and_topic_tree_root() {
        use crate::eversilver::memory::tree::score::extract::EntityKind;
        use crate::eversilver::memory::tree::score::resolver::CanonicalEntity;
