...
use crate::eversilver::memory::tree::retrieval::{
...
async fn ingest_populates_chunk_embeddings() {
    use crate::eversilver::memory::tree::jobs::drain_until_idle;
    use crate::eversilver::memory::tree::score::embed::EMBEDDING_DIM;
