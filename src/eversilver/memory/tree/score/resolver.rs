...
use crate::eversilver::memory::tree::score::extract::{EntityKind, ExtractedEntities};
...
mod tests {
    use super::*;
    use crate::eversilver::memory::tree::score::extract::ExtractedEntity;
    ...
    use crate::eversilver::memory::tree::score::extract::ExtractedTopic;
