...
use crate::eversilver::memory::tree::score::extract::ExtractedEntities;
use crate::eversilver::memory::tree::types::Metadata;
...
mod tests {
    use super::*;
    use crate::eversilver::memory::tree::score::extract::{
