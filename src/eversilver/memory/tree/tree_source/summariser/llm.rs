...
//! [`crate::eversilver::memory::tree::score::extract::llm::LlmEntityExtractor`].
//!
//! ## Responsibility
//!
...
use crate::eversilver::learning::extract::summary_facets::{self, StructuredSummary};
use crate::eversilver::memory::tree::chat::{ChatPrompt, ChatProvider};
use crate::eversilver::memory::tree::types::approx_token_count;
