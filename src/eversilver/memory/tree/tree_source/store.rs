...
//! [`crate::eversilver::memory::tree::score::embed::pack_embedding`]. New
...
use crate::eversilver::memory::tree::content_store::StagedSummary;
use crate::eversilver::memory::tree::score::embed::{decode_optional_blob, pack_checked};
