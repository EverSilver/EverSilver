...
//!
//! This is an isolated subdir under `eversilver::memory` implementing the
...
//! - `eversilver.memory_tree_ingest` — unified ingest; caller supplies
...
//! - `eversilver.memory_tree_get_chunk`
//!
