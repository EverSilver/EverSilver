...
use crate::eversilver::memory::tree::tree_global::{
...
use crate::eversilver::memory::tree::tree_source::types::{Buffer, SummaryNode, Tree, TreeKind};
...
async fn seal_one_level(
    ...
    let global_scope_slug =
        crate::eversilver::memory::tree::content_store::paths::slugify_source_id(&tree.scope);
