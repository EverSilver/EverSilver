...
//! [`crate::eversilver::agent::prompts::SystemPromptBuilder::build`]).
//!
...
//! the pattern used by
//! [`crate::eversilver::agent::prompts::ReflectionMemoryContextSection`].
...
mod tests {
    use super::*;
    use crate::eversilver::agent::prompts::types::{
        LearnedContextData, PromptContext, ToolCallFormat,
    };
    use crate::eversilver::memory::tool_memory::types::ToolMemorySource;
