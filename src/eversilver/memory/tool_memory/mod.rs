...
//! [issue #1400](https://github.com/eversilver/eversilver/issues/1400):
//! a first-class storage and retrieval surface for **actionable**
//! tool-specific guidance, distinct from the
//! [`tool_effectiveness`](crate::eversilver::learning::tool_tracker)
...
//!
//! [`PostTurnHook`]: crate::eversilver::agent::hooks::PostTurnHook
