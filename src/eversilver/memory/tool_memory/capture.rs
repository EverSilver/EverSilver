...
//! `tool_effectiveness`.
//!
//! [`ToolTrackerHook`]: crate::eversilver::learning::ToolTrackerHook
...
use crate::eversilver::agent::hooks::{PostTurnHook, ToolCallRecord, TurnContext};
...
mod tests {
    use super::*;
    use crate::eversilver::agent::hooks::ToolCallRecord;
    use crate::eversilver::memory::tool_memory::store::ToolMemoryStore;
    use crate::eversilver::memory::tool_memory::test_helpers::MockMemory;
    ...
    async fn safety_case_never_email_sarah_pins_into_prompt_block() {
        ...
        let rendered = crate::eversilver::memory::tool_memory::render_tool_memory_rules(&flat);
