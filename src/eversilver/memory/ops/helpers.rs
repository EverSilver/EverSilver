...
use crate::eversilver::memory::store::GraphRelationRecord;
...
/// It does **not** fall back to `~/.eversilver/workspace`; that hazard is the
/// one [`crate::eversilver::memory::global::client`] guards against, and it
