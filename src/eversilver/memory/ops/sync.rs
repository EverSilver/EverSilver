...
/// [`crate::eversilver::memory::IngestionStatusSnapshot`] but is the public RPC
...
///
/// Ingestion in Eversilver is listener/webhook-driven — there is no per-provider
...
pub async fn memory_ingestion_status() -> Result<RpcOutcome<IngestionStatusResult>, String> {
    let snapshot = match crate::eversilver::memory::global::client_if_ready() {
