...
use crate::eversilver::config::SchedulerGateConfig;
...
pub fn decide(signals: &Signals, cfg: &SchedulerGateConfig) -> Policy {
    use crate::eversilver::config::SchedulerGateMode;
...
mod tests {
    use super::*;
    use crate::eversilver::config::{SchedulerGateConfig, SchedulerGateMode};
