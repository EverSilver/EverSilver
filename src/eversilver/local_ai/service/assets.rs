...
use crate::eversilver::local_ai::paths::{
...
use crate::eversilver::local_ai::types::{
...
impl LocalAiService {
    ...
    pub(in crate::eversilver::local_ai::service) async fn ensure_stt_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::eversilver::local_ai::service) async fn ensure_tts_asset_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
