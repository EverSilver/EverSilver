...
use crate::eversilver::local_ai::lm_studio_api::{
...
use crate::eversilver::local_ai::ollama_api::OllamaModelTag;
...
pub(in crate::eversilver::local_ai::service) struct LmStudioCompletionOutcome {
    pub reply: String,
...
impl LocalAiService {
    pub(in crate::eversilver::local_ai::service) async fn ensure_lm_studio_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::eversilver::local_ai::service) async fn list_lm_studio_models(
        &self,
        config: &Config,
    ...
    pub(in crate::eversilver::local_ai::service) async fn has_lm_studio_model(
        &self,
        config: &Config,
        model: &str,
    ) -> Result<bool, String> {
    ...
    pub(in crate::eversilver::local_ai::service) async fn lm_studio_chat_completion(
        &self,
        config: &Config,
