...
use crate::eversilver::providers::{self, ProviderRuntimeOptions};
...
pub async fn local_ai_chat(
    ...
    let mut ollama_messages: Vec<crate::eversilver::local_ai::ollama_api::OllamaChatMessage> =
    ...
    for msg in messages.into_iter() {
        ...
        ollama_messages.push(crate::eversilver::local_ai::ollama_api::OllamaChatMessage {
