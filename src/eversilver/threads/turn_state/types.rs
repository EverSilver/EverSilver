...
use crate::eversilver::agent::task_board::TaskBoard;
...
/// Request payload for `eversilver.threads_turn_state_get`.
...
/// Response payload for `eversilver.threads_turn_state_get`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Response payload for `eversilver.threads_turn_state_list`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Request payload for `eversilver.threads_turn_state_clear`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
...
/// Response payload for `eversilver.threads_turn_state_clear`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
