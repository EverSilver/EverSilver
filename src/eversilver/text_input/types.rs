...
impl FieldBounds {
    pub fn from_element(b: &crate::eversilver::accessibility::ElementBounds) -> Self {
        Self {
            x: b.x,
            y: b.y,
            width: b.width,
    ...
    pub fn to_element(&self) -> crate::eversilver::accessibility::ElementBounds {
        crate::eversilver::accessibility::ElementBounds {
            x: self.x,
            y: self.y,
            width: self.width,
            height: self.height,
...
mod tests {
    use super::*;
    use crate::eversilver::accessibility::ElementBounds;
    use serde_json::json;
