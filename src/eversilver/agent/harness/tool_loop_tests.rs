use super::*;
use crate::eversilver::approval::ApprovalManager;
use crate::eversilver::config::AutonomyConfig;
use crate::eversilver::providers::traits::ProviderCapabilities;
use crate::eversilver::providers::ChatResponse;
use crate::eversilver::security::AutonomyLevel;
use crate::eversilver::tools::{ToolResult, ToolScope};
...
async fn run_tool_call_loop_aborts_when_stop_hook_returns_stop() {
    use crate::eversilver::agent::stop_hooks::{with_stop_hooks, StopDecision, StopHook, TurnState};
...
async fn run_tool_call_loop_applies_per_tool_max_result_size_cap() {
    ...
    impl Tool for CappedHugeTool {
        ...
        fn permission_level(&self) -> crate::eversilver::tools::PermissionLevel {
            crate::eversilver::tools::PermissionLevel::ReadOnly
        }
    ...
    assert!(
        ...
        crate::eversilver::util::utf8_safe_prefix_at_byte_boundary(&tool_results.content, 200)
    );
    assert!(
