...
//! the [`crate::eversilver::tools::Tool`] trait.
//!
//! [`PARENT_CONTEXT`] is set by the parent
//! [`crate::eversilver::agent::Agent`] around its `turn` so that any tool
...
use crate::eversilver::config::AgentConfig;
...
/// running inside [`crate::eversilver::agent::Agent::turn`] via the
...
pub struct ParentExecutionContext {
    ...
    pub connected_integrations: Vec<crate::eversilver::context::prompt::ConnectedIntegration>,
    ...
    pub tool_call_format: crate::eversilver::context::prompt::ToolCallFormat,
...
///
/// Returns `None` when called from outside [`crate::eversilver::agent::Agent::turn`]
