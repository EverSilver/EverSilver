...
use crate::eversilver::memory::store::events::{self, EventRecord, EventType};
use crate::eversilver::memory::store::fts5::{self, EpisodicEntry};
use crate::eversilver::memory::store::profile::{self, FacetType};
use crate::eversilver::memory::store::segments::{
...
fn extract_lesson_from_tools(
    tool_calls: &[crate::eversilver::agent::hooks::ToolCallRecord],
) -> Option<String> {
