...
//!    [`crate::eversilver::composio::ComposioClient`] to exercise the
...
use crate::eversilver::providers::{ChatMessage, ChatRequest, ChatResponse, Provider, ToolCall};
...
use crate::eversilver::composio::ComposioClient;
        ...
        Self {
            ...
            execute_responses: [
                ...
                (
                    ...
                    json!({
                        "messages": [
                            {"id": "m1", "subject": "Welcome", "from": "team@eversilver.com"},
...
impl FakeComposioBackend {
    ...
    /// ([`crate::eversilver::composio::ComposioActionTool`],
    ...
    /// resolves. Callers must hold `crate::eversilver::config::TEST_ENV_LOCK`
    ...
    pub async fn config_persisted(
        ...
        std::sync::Arc<crate::eversilver::config::Config>,
        std::path::PathBuf,
    ) {
        use crate::eversilver::credentials::{
        ...
        config.composio.mode = crate::eversilver::config::schema::COMPOSIO_MODE_BACKEND.to_string();
