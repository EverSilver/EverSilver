...
use crate::eversilver::agent::dispatcher::ToolDispatcher;
use crate::eversilver::agent::hooks::PostTurnHook;
use crate::eversilver::agent::memory_loader::MemoryLoader;
use crate::eversilver::agent::progress::AgentProgress;
use crate::eversilver::context::prompt::SystemPromptBuilder;
use crate::eversilver::context::ContextManager;
use crate::eversilver::memory::Memory;
use crate::eversilver::providers::{ChatMessage, ConversationMessage, Provider};
use crate::eversilver::tools::{Tool, ToolSpec};
...
pub struct Agent {
    ...
    pub(super) config: crate::eversilver::config::AgentConfig,
    pub(super) model_name: String,
    pub(super) temperature: f64,
    pub(super) workspace_dir: std::path::PathBuf,
    pub(super) skills: Vec<crate::eversilver::skills::Skill>,
    ...
    pub(super) last_turn_citations: Vec<crate::eversilver::agent::memory_loader::MemoryCitation>,
    ...
    ///
    /// [`AgentDefinitionRegistry`]: crate::eversilver::agent::harness::definition::AgentDefinitionRegistry
    ...
    /// [`crate::eversilver::context`] for the full surface.
    ...
    /// integration blocks.
    pub(super) connected_integrations: Vec<crate::eversilver::context::prompt::ConnectedIntegration>,
    ...
    pub(super) payload_summarizer:
        Option<Arc<dyn crate::eversilver::agent::harness::payload_summarizer::PayloadSummarizer>>,
    ...
    /// [`crate::eversilver::composio::cached_active_integrations`]; on
    ...
    /// produced by [`crate::eversilver::tools::orchestrator_tools::collect_orchestrator_tools`]
...
pub struct AgentBuilder {
    ...
    pub(super) config: Option<crate::eversilver::config::AgentConfig>,
    /// Optional [`ContextConfig`] override threaded through from
    /// `Agent::from_config`. When unset the builder falls back to
    /// [`crate::eversilver::config::ContextConfig::default`].
    pub(super) context_config: Option<crate::eversilver::config::ContextConfig>,
    pub(super) model_name: Option<String>,
    pub(super) temperature: Option<f64>,
    pub(super) workspace_dir: Option<std::path::PathBuf>,
    pub(super) skills: Option<Vec<crate::eversilver::skills::Skill>>,
