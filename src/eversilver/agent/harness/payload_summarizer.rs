...
//! [`crate::eversilver::config::ContextConfig::tool_result_budget_bytes`],
...
//! ([`crate::eversilver::agent::harness::session::builder::AgentBuilder`]
...
/// [`crate::eversilver::agent::harness::session::Agent::execute_tool_call`]
...
pub struct SubagentPayloadSummarizer {
    ...
    /// [`crate::eversilver::config::ContextConfig`] (500 000 tokens).
    ...
    /// [`crate::eversilver::config::ContextConfig`] (2 000 000 tokens).
...
/// [`crate::eversilver::tree_summarizer::types::estimate_tokens`] but
