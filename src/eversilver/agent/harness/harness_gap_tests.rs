...
use crate::eversilver::agent::harness::tool_loop::run_tool_call_loop;
use crate::eversilver::context::guard::{ContextCheckResult, ContextGuard};
use crate::eversilver::providers::traits::ProviderCapabilities;
use crate::eversilver::providers::Provider;
use crate::eversilver::providers::{ChatMessage, ChatRequest, ChatResponse, UsageInfo};
use crate::eversilver::tool_timeout::parse_tool_timeout_secs;
...
fn multimodal_cfg() -> crate::eversilver::config::MultimodalConfig {
    crate::eversilver::config::MultimodalConfig::default()
}
...
async fn max_iterations_exceeded_downcasts_to_typed_agent_error() {
    ...
    assert!(
        crate::eversilver::agent::error::is_max_iterations_error(&err.to_string()),
...
fn parse_tool_calls_invoke_tag_with_json_body() {
    use crate::eversilver::agent::harness::parse::parse_tool_calls;
...
fn datetime_section_output_matches_iso8601_date_and_utc_offset_pattern() {
    use crate::eversilver::agent::prompts::{DateTimeSection, PromptContext, PromptSection};
    use std::collections::HashSet;
    use std::path::Path;
    use std::sync::LazyLock;

    static EMPTY_FILTER: LazyLock<HashSet<String>> = LazyLock::new(HashSet::new);
    static EMPTY_TOOLS: &[crate::eversilver::agent::prompts::PromptTool<'static>] = &[];
    static EMPTY_INTEGRATIONS: &[crate::eversilver::context::prompt::ConnectedIntegration] = &[];
    ...
    let ctx = PromptContext {
        ...
        learned: crate::eversilver::agent::prompts::LearnedContextData::default(),
