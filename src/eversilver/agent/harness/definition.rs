...
//! [`crate::eversilver::agent::agents`] — one subfolder per agent, each
...
//! to `~/.eversilver/agents/*.toml` for user-global specialists) which
...
pub struct AgentDefinition {
    ...
    /// [`crate::eversilver::context::prompt::render_subagent_system_prompt`].
    #[serde(default = "defaults::true_")]
    ...
    ///
    /// [`ArchetypeDelegationTool`]: crate::eversilver::tools::impl::agent::ArchetypeDelegationTool
    /// [`SkillDelegationTool`]: crate::eversilver::tools::impl::agent::SkillDelegationTool
    #[serde(default)]
...
/// full runtime [`crate::eversilver::context::prompt::PromptContext`]
...
/// [`crate::eversilver::context::prompt`] in the order the builder
/// wants.
pub type PromptBuilder =
    fn(&crate::eversilver::context::prompt::PromptContext<'_>) -> anyhow::Result<String>;
...
pub enum PromptSource {
    ...
    /// `src/eversilver/agent/prompts/` for built-ins. Resolved by the runner
    /// at spawn time.
    File { path: String },
...
impl AgentDefinitionRegistry {
    ...
    /// `~/.eversilver/agents/*.toml` fallback). Custom definitions
    ...
    /// [`crate::eversilver::config::Config::load_or_init`] and load from
    /// it. Built for sync CLI call sites (`eversilver agent list`,
    ...
    pub async fn load_for_default_workspace() -> Result<Self> {
        let config = crate::eversilver::config::Config::load_or_init().await?;
