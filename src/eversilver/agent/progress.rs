...
pub enum AgentProgress {
    ...
    /// from inside [`crate::eversilver::agent::harness::subagent_runner`]**
    ...
    TaskBoardUpdated {
        board: crate::eversilver::agent::task_board::TaskBoard,
    },
    ...
    /// [`crate::eversilver::agent::cost::TurnCost::total_usd`].
    TurnCostUpdated {
