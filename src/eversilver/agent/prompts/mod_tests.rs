...
impl Tool for TestTool {
    ...
    async fn execute(
        ...
        Ok(crate::eversilver::tools::ToolResult::success("ok"))
    }
}
...
fn identity_section_creates_missing_workspace_files() {
    ...
    assert!(
        ...
        "SOUL.md should be seeded from src/eversilver/agent/prompts/SOUL.md"
    );
...
fn welcome_agent_definition_flags_still_load_profile_md() {
    ...
    // Match `src/eversilver/agent/agents/welcome/agent.toml` exactly.
