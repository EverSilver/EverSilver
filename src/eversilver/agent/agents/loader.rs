...
pub struct BuiltinAgent {
    ...
    /// with a populated [`crate::eversilver::agent::harness::definition::PromptContext`]
...
mod tests {
    use super::*;
    use crate::eversilver::agent::harness::definition::{ModelSpec, SandboxMode, ToolScope};
    ...
    fn orchestrator_subagents_include_crypto_agent() {
        use crate::eversilver::agent::harness::definition::SubagentEntry;
        let def = find("orchestrator");
