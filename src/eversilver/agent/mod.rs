...
//!
//! This domain owns the core "brain" of Eversilver. It coordinates how LLMs
...
/// `eversilver::context::prompt` so prompt rendering lives next to the
/// agents that consume it. `eversilver::context::prompt` is retained as
