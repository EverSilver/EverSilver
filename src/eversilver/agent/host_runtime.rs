...
use crate::eversilver::config::RuntimeConfig;
...
pub struct DockerRuntime {
    config: crate::eversilver::config::DockerRuntimeConfig,
}

impl DockerRuntime {
    fn new(config: crate::eversilver::config::DockerRuntimeConfig) -> Self {
        Self { config }
    }
}
...
mod tests {
    use super::*;
    use crate::eversilver::config::{DockerRuntimeConfig, RuntimeConfig};
    ...
    fn native_runtime_reports_capabilities_and_shell_command() {
        ...
        assert!(runtime.storage_path().ends_with("eversilver/runtime"));
    ...
    fn docker_runtime_builds_expected_flags() {
        ...
        assert!(runtime.storage_path().ends_with("eversilver/runtime/docker"));
