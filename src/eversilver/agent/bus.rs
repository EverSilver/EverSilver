...
//!
//! See [`crate::eversilver::channels::runtime::dispatch`] for the primary
//! caller.
...
// ── Shared test helpers ──────────────────────────────────────────────────
//
// Any test in `eversilver_core` that needs to stub or exercise the real
...
///
/// ```ignore
/// use crate::eversilver::agent::bus::{mock_agent_run_turn, AgentTurnResponse};
