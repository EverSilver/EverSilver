#[cfg(test)]
mod tests {
    use crate::eversilver::subconscious::decision_log::DecisionLog;
    use crate::eversilver::subconscious::store;
    use crate::eversilver::subconscious::types::{
    ...
    fn engine_construction_seeds_default_tasks() {
        use crate::eversilver::config::HeartbeatConfig;
        use crate::eversilver::subconscious::SubconsciousEngine;
