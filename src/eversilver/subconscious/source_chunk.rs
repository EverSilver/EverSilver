...
fn resolve_one(config: &crate::eversilver::config::Config, raw: &str) -> SourceChunk {
...
/// [`crate::eversilver::subconscious::situation_report::summaries`] but
...
fn resolve_summary(config: &crate::eversilver::config::Config, raw: &str) -> SourceChunk {
    ...
    let lookup: anyhow::Result<Option<(String, i64, String)>> =
        crate::eversilver::memory::tree::store::with_connection(config, |conn| {
...
fn resolve_entity(config: &crate::eversilver::config::Config, raw: &str) -> SourceChunk {
