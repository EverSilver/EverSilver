...
use super::*;
use crate::eversilver::subconscious::reflection::{hydrate_draft, ReflectionDraft, ReflectionKind};
...
fn fresh_conn() -> Connection {
    ...
    conn.execute_batch(crate::eversilver::subconscious::store::SCHEMA_DDL_FOR_TESTS)
        .expect("apply DDL");
    conn
}
