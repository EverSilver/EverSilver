...
//! left to the Tauri shell or an explicit `eversilver.update_apply` RPC call.

use std::time::Duration;

use crate::core::event_bus::{publish_global, DomainEvent};
use crate::eversilver::config::UpdateConfig;
use crate::eversilver::update::core as update_core;
