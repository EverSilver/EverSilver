...
fn get_router() -> Result<std::sync::Arc<crate::eversilver::webhooks::WebhookRouter>, String> {
    crate::eversilver::socket::global_socket_manager()
...
pub async fn trigger_agent(
    ...
    use crate::eversilver::agent::triage::TriggerEnvelope;
    ...
    let outcome = tokio::time::timeout(
        ...
        crate::eversilver::agent::triage::run_triage(&envelope),
    )
    .await
...
pub fn build_echo_response(request: &WebhookRequest) -> WebhookResponseData {
    ...
    headers.insert("x-eversilver-webhook-target".to_string(), "echo".to_string());
