//! `eversilver.connectivity_diag` RPC.
//!
...
use crate::eversilver::socket::manager::global_socket_manager;
use crate::rpc::RpcOutcome;

use super::ops::is_port_in_use;

/// Lightweight diagnostic payload returned by `eversilver.connectivity_diag`.
///
