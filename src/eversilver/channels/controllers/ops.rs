...
use crate::eversilver::config::{Config, DiscordConfig, IMessageConfig, TelegramConfig};
    ...
    if channel_id == "telegram" && auth_mode == ChannelAuthMode::BotToken {
        ...
        let (stream_mode, draft_update_interval_ms, silent_streaming, mention_only) =
            if let Some(existing) = persisted.channels_config.telegram.as_ref() {
                ...
                (
                    crate::eversilver::config::StreamMode::default(),
                    1000,
                    true,
                    false,
                )
...
pub async fn discord_list_guilds(
    ...
    RpcOutcome<Vec<crate::eversilver::channels::providers::discord::api::DiscordGuild>>,
    String,
> {
    use crate::eversilver::channels::providers::discord::api;
...
pub async fn discord_list_channels(
    ...
    RpcOutcome<Vec<crate::eversilver::channels::providers::discord::api::DiscordTextChannel>>,
    String,
> {
    use crate::eversilver::channels::providers::discord::api;
...
pub async fn discord_check_permissions(
    ...
    RpcOutcome<crate::eversilver::channels::providers::discord::api::BotPermissionCheck>,
    String,
> {
    use crate::eversilver::channels::providers::discord::api;
