...
use crate::eversilver::config::{Config, StreamMode};
use crate::eversilver::security::pairing::PairingGuard;
use anyhow::Context;
...
impl TelegramChannel {
    ...
    pub(crate) fn http_client(&self) -> reqwest::Client {
        crate::eversilver::config::build_runtime_proxy_client("channel.telegram")
    }
    ...
    async fn load_config_without_env() -> anyhow::Result<Config> {
        ...
        let eversilver_dir = home.join(".eversilver");
