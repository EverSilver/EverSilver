...
use crate::eversilver::config::StreamMode;
use std::path::Path;
...
async fn test_thinking_placeholder_logic() {
    ...
    use crate::eversilver::channels::traits::Channel;
    use crate::eversilver::channels::SendMessage;
    ...
    impl Channel for MockTelegramChannel {
        ...
        async fn listen(
            &self,
            _: tokio::sync::mpsc::Sender<crate::eversilver::channels::traits::ChannelMessage>,
        ) -> anyhow::Result<()> {
            Ok(())
        }
