...
fn new_stores_all_fields() {
    ...
    assert_eq!(ch.username, "eversilver");
...
fn irc_config_serde_roundtrip() {
    use crate::eversilver::config::schema::IrcConfig;
    ...
    assert_eq!(parsed.username.as_deref(), Some("eversilver"));
