...
use crate::eversilver::providers::{ChatMessage, Provider};
...
pub(crate) struct ChannelRuntimeContext {
    ...
    pub(crate) reliability: Arc<crate::eversilver::config::ReliabilityConfig>,
    pub(crate) provider_runtime_options: crate::eversilver::providers::ProviderRuntimeOptions,
    pub(crate) workspace_dir: Arc<PathBuf>,
    pub(crate) message_timeout_secs: u64,
    pub(crate) multimodal: crate::eversilver::config::MultimodalConfig,
}
...
pub(crate) async fn build_memory_context(
    ...
    if let Ok(entries) = mem
        .recall(user_msg, 5, crate::eversilver::memory::RecallOpts::default())
        .await
    {
...
mod tests {
    ...
    use crate::eversilver::memory::{Memory, MemoryCategory, MemoryEntry};
    use crate::eversilver::providers::Provider;
    use crate::eversilver::tools::{Tool, ToolResult};
    ...
    fn runtime_context() -> ChannelRuntimeContext {
        ChannelRuntimeContext {
            ...
            api_url: None,
            inference_url: None,
            reliability: Arc::new(crate::eversilver::config::ReliabilityConfig::default()),
            provider_runtime_options: crate::eversilver::providers::ProviderRuntimeOptions::default(
            ),
            workspace_dir: Arc::new(PathBuf::from("/tmp")),
            message_timeout_secs: CHANNEL_MESSAGE_TIMEOUT_SECS,
            multimodal: crate::eversilver::config::MultimodalConfig::default(),
        }
    }
    ...
    fn clear_and_compact_sender_history_update_cached_messages() {
        ...
        history.push(crate::eversilver::providers::ChatMessage::user("short"));
        history.extend(
            (0..20).map(|idx| {
                crate::eversilver::providers::ChatMessage::assistant("x".repeat(700 + idx))
            }),
        );
        ctx.conversation_histories
            .lock()
