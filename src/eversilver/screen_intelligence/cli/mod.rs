//! `eversilver screen-intelligence` — standalone CLI for the screen intelligence loop.
//!
...
//!
//! Usage:
//!   eversilver screen-intelligence run       [--ttl <secs>] [--keep] [-v]
//!   eversilver screen-intelligence status    [-v]
//!   eversilver screen-intelligence capture   [--keep] [-v]
//!   eversilver screen-intelligence start     [--ttl <secs>] [-v]
//!   eversilver screen-intelligence stop      [-v]
//!   eversilver screen-intelligence doctor    [-v]
//!   eversilver screen-intelligence vision    [--limit <n>] [-v]
...
/// Entry point for `eversilver screen-intelligence <subcommand>`.
pub(crate) fn run_screen_intelligence_command(args: &[String]) -> Result<()> {
    ...
    match args[0].as_str() {
        ...
        other => Err(anyhow::anyhow!(
            "unknown screen-intelligence subcommand '{other}'. Run `eversilver screen-intelligence --help`."
        )),
    }
}
...
pub(super) async fn bootstrap_engine(
    verbose: bool,
) -> Result<Arc<crate::eversilver::screen_intelligence::AccessibilityEngine>> {
...
pub(super) async fn bootstrap_engine_with_opts(
    ...
    use crate::eversilver::screen_intelligence::global_engine;
...
fn print_help() {
    println!("eversilver screen-intelligence — standalone screen intelligence runtime\n");
    ...
    println!("Usage:");
    println!("  eversilver screen-intelligence run       [--ttl <secs>] [--no-vision-model] [-v]");
    println!("  eversilver screen-intelligence status     [-v]");
    println!("  eversilver screen-intelligence capture    [--keep] [-v]");
    println!("  eversilver screen-intelligence start      [--ttl <secs>] [--no-vision-model] [-v]");
    println!("  eversilver screen-intelligence stop       [-v]");
    println!("  eversilver screen-intelligence doctor     [-v]");
    println!("  eversilver screen-intelligence vision     [--limit <n>] [-v]");
    println!();
    println!("Subcommands:");
