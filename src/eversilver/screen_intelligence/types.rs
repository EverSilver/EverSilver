use crate::eversilver::config::ScreenIntelligenceConfig;
use serde::{Deserialize, Serialize};

// Permission types are defined in the accessibility middleware; re-export for compatibility.
pub use crate::eversilver::accessibility::{GlobeHotkeyPollResult, GlobeHotkeyStatus};
pub use crate::eversilver::accessibility::{PermissionKind, PermissionState, PermissionStatus};
