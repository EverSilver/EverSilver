...
//! [`crate::eversilver::config::ComposioConfig::mode`] toggle — see
...
use crate::eversilver::agent::harness::current_sandbox_mode;
use crate::eversilver::agent::harness::definition::SandboxMode;
...
pub struct ComposioActionTool {
    ...
    /// the [`crate::eversilver::config::ComposioConfig::mode`] toggle is
...
mod tests {
    ...
    async fn mode_toggle_between_calls_is_observed() {
        ...
        direct_config.composio.mode =
            crate::eversilver::config::schema::COMPOSIO_MODE_DIRECT.to_string();
