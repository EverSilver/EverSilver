...
use crate::eversilver::composio::types::ComposioExecuteResponse;
...
/// migration in [`crate::eversilver::composio::tools::ComposioExecuteTool`].
#[derive(Clone)]
...
impl ProviderContext {
    ...
    pub fn memory_client(&self) -> Option<crate::eversilver::memory::MemoryClientRef> {
        crate::eversilver::memory::global::client_if_ready()
    }
}
