...
//!    [`crate::eversilver::context::session_memory`].
//!
//! # Cache contract
//!
...
use crate::eversilver::providers::{ConversationMessage, UsageInfo};
...
impl ContextPipeline {
    ...
    /// observability / [`crate::eversilver::context::ContextStats`].
