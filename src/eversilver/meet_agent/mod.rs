...
//! ## RPC surface
//!
//! - `eversilver.meet_agent_start_session`  — open a session for a `request_id`
//! - `eversilver.meet_agent_push_listen_pcm` — shell pushes captured PCM frames
//! - `eversilver.meet_agent_poll_speech`     — shell pulls synthesized PCM frames
//! - `eversilver.meet_agent_stop_session`    — close session, flush pending audio
