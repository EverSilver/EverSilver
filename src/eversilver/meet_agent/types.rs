...
/// Inputs to `eversilver.meet_agent_start_session`.
#[derive(Debug, Clone, Deserialize)]
pub struct StartSessionRequest {
    /// `request_id` minted by `eversilver.meet_join_call`. Used as the
...
/// Outputs from `eversilver.meet_agent_start_session`.
...
/// Inputs to `eversilver.meet_agent_push_listen_pcm`.
///
...
/// Inputs to `eversilver.meet_agent_poll_speech`.
///
...
/// Inputs to `eversilver.meet_agent_push_caption`.
///
...
/// Inputs to `eversilver.meet_agent_stop_session`.
#[derive(Debug, Clone, Deserialize)]
...
pub struct StopSessionResponse {
    ...
    /// for telemetry and the smoke test in [`crate::eversilver::meet_agent`].
