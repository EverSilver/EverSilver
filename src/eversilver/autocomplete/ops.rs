...
pub async fn autocomplete_history(
    ...
    let entries = crate::eversilver::autocomplete::history::list_history(requested_limit).await?;
...
pub async fn autocomplete_clear_history(
    ...
    let cleared = crate::eversilver::autocomplete::history::clear_history().await?;
    Ok(RpcOutcome::new(
