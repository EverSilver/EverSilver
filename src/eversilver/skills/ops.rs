...
//! - **User**: `~/.eversilver/skills/<name>/` or `~/.agents/skills/<name>/`
//! - **Project**: `<workspace>/.eversilver/skills/<name>/` or
//!   `<workspace>/.agents/skills/<name>/`
//!
//! Project-scope skills are only loaded when a trust marker
//! (`<workspace>/.eversilver/trust`) is present. When a skill name collides
