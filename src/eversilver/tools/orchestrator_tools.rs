...
//!
//! Called from [`crate::eversilver::agent::harness::session::builder`] at
...
//!
//! [`AgentDefinition::when_to_use`]: crate::eversilver::agent::harness::definition::AgentDefinition::when_to_use
//! [`SubagentEntry::AgentId`]: crate::eversilver::agent::harness::definition::SubagentEntry::AgentId
//! [`SubagentEntry::Skills`]: crate::eversilver::agent::harness::definition::SubagentEntry::Skills

use crate::eversilver::agent::harness::definition::{
    AgentDefinition, AgentDefinitionRegistry, SubagentEntry,
};
use crate::eversilver::context::prompt::ConnectedIntegration;

// SpawnWorkerThreadTool import kept commented while the worker-thread spawn is
// temporarily disabled (see eversilver/eversilver#1624).
...
pub fn collect_orchestrator_tools(
    ...
    // showcase (see eversilver/eversilver#1624). Re-enable once the
    ...
    fn collects_agentid_entries_and_collapses_skills_wildcard() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                // see eversilver/eversilver#1624. Re-add the leading entry
