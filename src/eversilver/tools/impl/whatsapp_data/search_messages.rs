...
use crate::eversilver::whatsapp_data::rpc as whatsapp_rpc;
use crate::eversilver::whatsapp_data::types::SearchMessagesRequest;
...
mod tests {
    use super::*;
    use crate::eversilver::tools::traits::{PermissionLevel, ToolScope};
