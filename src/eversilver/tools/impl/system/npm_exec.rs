...
//! [`crate::eversilver::node_runtime::NodeBootstrap`] for binary resolution.
//! Same security posture as
//! [`crate::eversilver::tools::impl::system::shell::ShellTool`] and
//! [`crate::eversilver::tools::impl::system::node_exec::NodeExecTool`]:
//!
...
use crate::eversilver::agent::host_runtime::RuntimeAdapter;
        ...
        match result {
            Ok(Ok(output)) => {
                ...
                if stdout.len() > MAX_OUTPUT_BYTES {
                    stdout.truncate(crate::eversilver::util::floor_char_boundary(
                        &stdout,
                        MAX_OUTPUT_BYTES,
                    ));
                ...
                if stderr.len() > MAX_OUTPUT_BYTES {
                    stderr.truncate(crate::eversilver::util::floor_char_boundary(
                        &stderr,
                        MAX_OUTPUT_BYTES,
                    ));
