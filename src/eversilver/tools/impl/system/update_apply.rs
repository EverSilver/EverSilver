...
//!
//! Wraps [`crate::eversilver::update::rpc::update_run`] so the LLM can
...
use crate::eversilver::security::{SecurityPolicy, ToolOperation};
...
impl UpdateApplyTool {
    ...
    /// `[eversilver:policy]` log format and would silently miss any
