...
use crate::eversilver::agent::harness::definition::{AgentDefinition, AgentDefinitionRegistry};
...
mod tests {
    ...
    fn parent_context_with_provider(
        ...
        let agent_config = crate::eversilver::config::AgentConfig {
            max_parallel_tools,
            ..Default::default()
        };
        ParentExecutionContext {
