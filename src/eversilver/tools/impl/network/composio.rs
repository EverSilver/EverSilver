...
//
// When enabled, Eversilver can execute actions on Gmail, Notion, GitHub, Slack, etc.
...
use crate::eversilver::security::policy::ToolOperation;
use crate::eversilver::security::SecurityPolicy;
use crate::eversilver::tools::traits::{Tool, ToolCategory, ToolResult};
use anyhow::Context;
...
impl ComposioTool {
    ...
    fn client(&self) -> Client {
        crate::eversilver::config::build_runtime_proxy_client_with_timeouts("tool.composio", 60, 10)
    }
...
fn sanitize_error_message(message: &str) -> String {
    ...
    crate::eversilver::util::truncate_with_ellipsis(&sanitized, 240)
}
