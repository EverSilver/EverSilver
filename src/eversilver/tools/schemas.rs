...
use crate::eversilver::tools::traits::Tool;
...
fn handle_web_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let config = config_rpc::load_config_with_timeout().await?;
        let client = crate::eversilver::integrations::build_client(&config).ok_or_else(|| {
        ...
        let resp = client
            .post::<crate::eversilver::integrations::parallel::SearchResponse>(
...
fn handle_seltz_search(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let tool = crate::eversilver::integrations::SeltzSearchTool::new(
...
fn handle_apify_linkedin_scrape(params: Map<String, Value>) -> ControllerFuture {
    Box::pin(async move {
        ...
        let data = crate::eversilver::learning::linkedin_enrichment::scrape_linkedin_profile(
            &client,
            &profile_url,
        )
        .await
        ...
        let markdown = crate::eversilver::learning::linkedin_enrichment::render_profile_markdown(
            &profile_url,
            &data,
        );
