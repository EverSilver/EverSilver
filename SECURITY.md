...
We provide security updates for the following versions of Eversilver:
...
We recommend always running the [latest release](https://github.com/eversilver/eversilver/releases/latest). Eversilver is in early beta; older versions may not receive patches.
...
2. Email the maintainers with a clear description of the issue, steps to reproduce, and impact. You can reach us via the contact details listed in the [Eversilver organization](https://github.com/eversilverxyz) or repository.
...
Out-of-scope for this process: general bugs, feature requests, and issues in third-party services we integrate with (e.g., Telegram, Notion) unless they are specific to how Eversilver uses them.
...
Thank you for helping keep Eversilver and its users safe.
