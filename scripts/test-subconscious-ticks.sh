...
CORE_BIN="./app/src-tauri/binaries/eversilver-core-x86_64-pc-windows-msvc.exe"
RPC_PORT=7810
...
# The core reads EVERSILVER_CORE_TOKEN at startup and skips writing a token file.
...
EVERSILVER_CORE_PORT="$RPC_PORT" EVERSILVER_CORE_TOKEN="$RPC_TOKEN" "$CORE_BIN" serve > /tmp/subconscious-test.log 2>&1 &
SERVER_PID=$!
...
WORKSPACE="$HOME/.eversilver/workspace"
mkdir -p "$WORKSPACE"
...
RESULT=$(rpc "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"eversilver.memory_doc_ingest\",\"params\":{\"namespace\":\"skill-gmail\",\"key\":\"tick1-gmail\",\"title\":\"Deadline reminder and meeting invite\",\"content\":$GMAIL1_ESC,\"source_type\":\"gmail\",\"priority\":\"high\",\"category\":\"core\"}}")
...
RESULT=$(rpc "{\"jsonrpc\":\"2.0\",\"id\":2,\"method\":\"eversilver.memory_doc_ingest\",\"params\":{\"namespace\":\"skill-notion\",\"key\":\"tick1-notion\",\"title\":\"Q1 Delivery Tracker\",\"content\":$NOTION1_ESC,\"source_type\":\"notion\",\"priority\":\"high\",\"category\":\"core\"}}")
...
RESULT=$(rpc "{\"jsonrpc\":\"2.0\",\"id\":4,\"method\":\"eversilver.memory_doc_ingest\",\"params\":{\"namespace\":\"skill-gmail\",\"key\":\"tick2-gmail\",\"title\":\"URGENT deadline moved to tomorrow\",\"content\":$GMAIL2_ESC,\"source_type\":\"gmail\",\"priority\":\"high\",\"category\":\"core\"}}")
...
RESULT=$(rpc "{\"jsonrpc\":\"2.0\",\"id\":5,\"method\":\"eversilver.memory_doc_ingest\",\"params\":{\"namespace\":\"skill-notion\",\"key\":\"tick2-notion\",\"title\":\"Q1 Tracker updated - unblocked\",\"content\":$NOTION2_ESC,\"source_type\":\"notion\",\"priority\":\"high\",\"category\":\"core\"}}")
