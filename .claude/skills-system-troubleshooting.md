...
- Error paths like `/Users/cyrus/eversilver/skills/skills/telegram/`
...
This downloads the skills repository from `https://github.com/eversilverxyz/skills`.
...
- **Production**: Skills in `~/.eversilver/skills/`
